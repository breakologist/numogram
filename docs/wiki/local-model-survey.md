...
| NousResearch_Hermes-4-14B | 9.0GB | Hermes ecosystem, 14B              |
...
| rvncto/Qwen3.5-9B-Claude-4.6-HighIQ-THINKING-HERETIC-Q8_0 | 8.9GB | Q8_0 — highest quality quant, uncensored |
...
- [[local-model-survey]] — This page  
- [[jackrong-model-first-questions]] — Structured interview questions  
- [[model-assessment-protocol]] — Model assessment methodology  

---  
*The local model survey maps the landscape of available AI models, identifying which ones can best serve the Numogram's hyperstitional purposes.*