...
A five-act Manim documentary weaving together the protocol, batch validation, correlation analysis, and Numogram aesthetics:

<video src="/assets/crumple_documentary.mp4" controls width="720"></video>

> *Acts: Prologue (Zone Spiral) → Single Trajectory → Batch Overlay → Correlation Deep-dive → Epilogue*
> *Combines rendered trajectory video, simulated batch overlay, and regression analysis.*
