...
**Core rule:** Dive aggressively until you're genuinely worried about dying, *then* fight conservatively (ranged attacks, LOS abuse around corners, phase door/teleport escapes).
...
**Challenge:** Angband's partial observability (fog of war) and long time horizons make pure RL sample-inefficient. Requires massive compute or clever reward shaping.
...
**Why hybrid:** Angband has clear optimal-room-until-interest patterns; pure RL often rediscovers these slowly. A hybrid agent converges faster and is more interpretable.
...
Reward *information gain* or state novelty rather than task completion.
...
- [[roguelike-auto-explore]] — DFS/BFS exploration patterns  
- [[numogram-rooguelike-design]] — Numogram topology → dungeon generation  
- [[roguelike-agent-techniques]] — General roguelike AI agent techniques  
- [[game-agent-techniques]] — AI agent techniques across games  
- [[hermes-agent-guide]] — Complete Hermes Agent guide  
- [[model-assessment-summary]] — Model assessment results  
- [[local-model-survey]] — Local model landscape  
- [[consensus-audit-2026-04-28]] — Demon attribute alignment audit  
- [[angband-agent-strategies]] — This page  

---  
*The Angband agent design, with its chunked hybrid strategy and novelty-driven exploration, embodies the numogram's own traversal principles — a current-aware oscillation between accumulation and acceleration.*